 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const re=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),p=(e,t)=>{const n=v.forwardRef(({color:u="currentColor",size:o=24,strokeWidth:s=2,absoluteStrokeWidth:i,className:c="",children:a,...f},I)=>v.createElement("svg",{ref:I,...te,width:o,height:o,stroke:u,strokeWidth:i?Number(s)*24/Number(o):s,className:["lucide",`lucide-${re(e)}`,c].join(" "),...f},[...t.map(([q,D])=>v.createElement(q,D)),...Array.isArray(a)?a:[a]]));return n.displayName=`${e}`,n};/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const de=p("Thermometer",[["path",{d:"M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z",key:"17jzev"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ke=p("Zap",[["polygon",{points:"13 2 3 14 12 14 11 22 21 10 12 10 13 2",key:"45s27k"}]]);export{oe as A,ue as B,ce as C,ie as D,le as G,fe as M,ye as P,ne as R,he as S,de as T,ke as Z,ae as a,se as b,pe as c,v as r};
//# sourceMappingURL=icons-Bp5PhT8O.js.map
